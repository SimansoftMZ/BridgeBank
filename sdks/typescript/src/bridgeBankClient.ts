 ...
 */
export interface BridgeBankClient extends BaseRequestBuilder<BridgeBankClient> {
    /**
     * The api property
     */
 ...
 */
// @ts-ignore
export function createBridgeBankClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BridgeBankClient>(requestAdapter, pathParameters, BridgeBankClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BridgeBankClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BridgeBankClientNavigationMetadata: Record<Exclude<keyof BridgeBankClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
